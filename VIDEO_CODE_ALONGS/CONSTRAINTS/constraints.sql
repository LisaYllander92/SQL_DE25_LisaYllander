...
-- 'duckdb' (only) to open in terminal

-- NOT NULL constraint: column cannot have NULL value
CREATE TABLE students 
    (name VARCHAR NOT NULL, age UINT8); -- UINT8 = unsigned integer
-- '.read constraints.sql' to read file in terminal
-- 'desc table students;' to view table in terminal
